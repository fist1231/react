...
import EditProposalForm from '../forms/formik/EditProposalForm';
...
class EditProposalModal extends Component {
        ...
        <Content onClick={() => dispatch(hideModal())}>
          <Dialog onClick={onDialogClick}>
            <div className="modal-header">
                <h3 className="modal-title">Edit Proposal {proposal.RESPONSE_NUMBER}-{proposal.RESPONSE_SEQ_NUMBER}</h3>
            </div>
            <EditProposalForm proposal={proposal} hideModal={this.props.onFormSubmit} />
          </Dialog>
        </Content>
      </div>
  );
